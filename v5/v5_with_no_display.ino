//$ last work 26/August/23 [03:56 PM]
// # version 5.2.3
// # Release Note : Time is not fetched and store in RTC struct element and
// # display functionality is also disabled
...
void updateVariablesValues(String str) {
  ...
  if (newValues == 0) {
    ...
    //     displayWorking = true;
    //   }
    // } //` display functionality is disabled as it is mentioned in file name
